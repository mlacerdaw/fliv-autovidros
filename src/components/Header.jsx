...
const Header = () => {
  ...
  return (
    <header className="bg-fliv-blue-secondary text-white shadow-md sticky top-0 z-40">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 md:h-20">
        <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          <img src="/images/logo/fliv-branco.png" alt="FLIV Logo" className="h-12 md:h-20 w-auto" />
        </Link>
